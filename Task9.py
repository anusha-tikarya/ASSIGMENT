...
class Bank:
    ...
    def create_account(self):
        ...
        if choice == 1:
            account = SavingsAccountV2(account_number, customer_name, balance)
        elif choice == 2:
            account = CurrentAccountV2(account_number, customer_name, balance)
        else:
    ...
    def calculate_interest(self, account_number):
        for account in self.accounts:
            if isinstance(account, SavingsAccountV2) and account.get_account_number() == account_number:
